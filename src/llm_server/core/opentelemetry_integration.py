...
try:
    ...
    _OTEL_ENABLED = False
    _meter = _tracer = SpanKind = Resource = None
...
CIRCUIT_BREAKER_STATE_CHANGES_TOTAL = _meter.create_counter(
...
def instrument_with_trace(
    name: str, span_kind: "SpanKind" = "INTERNAL"
