...
from llm_server.core.implementations import DSPyModelBackend, ImageProcessor, ModelProcessor
...
from llm_server.core.output_processors import DefaultOutputProcessor, ContactExtractorProcessor
...
def create_extract_contact_processor(
    ...
    from llm_server.core.implementations import ImageProcessor
