...
async def list_programs(request: Request, tags: Optional[str] = None):
...
async def get_program_details(program_id: str, request: Request):
...
async def list_program_versions(program_id: str, request: Request):
...
async def get_execution_history(
    ...
    executions = program_manager.get_execution_history(
        program_id=program_id, model_id=model_id, limit=limit
    )
