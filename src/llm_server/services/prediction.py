...
class PredictionService:
    ...
    async def predict(self, request: Union[QueryRequest, Dict[str, Any]]) -> Tuple[str, Optional[Any]]:
        """
        ...
        if isinstance(request, QueryRequest) and hasattr(request, "model_extra") and request.model_extra:
